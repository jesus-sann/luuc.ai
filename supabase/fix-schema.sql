-- ===========================================
-- LUUC.AI - FIX: Agregar tablas de empresas
-- ===========================================
...
-- ===========================================
-- 4. AGREGAR company_id A documents (si no existe)
-- ===========================================
DO $$
BEGIN
    IF NOT EXISTS (
...
-- ===========================================
-- 5. AGREGAR company_id A analyses (si no existe)
-- ===========================================
DO $$
BEGIN
    IF NOT EXISTS (
...
-- ===========================================
-- 8. POLÍTICAS RLS PARA companies
-- ===========================================
...
-- SELECT: Ver empresa propia o empresa a la que pertenece
CREATE POLICY "Users can view their company"
    ON public.companies FOR SELECT
    USING (
        user_id = auth.uid()
        OR id IN (SELECT company_id FROM public.users WHERE id = auth.uid())
    );

-- INSERT: Crear empresa propia
CREATE POLICY "Users can insert their company"
    ON public.companies FOR INSERT
    WITH CHECK (user_id = auth.uid());

-- UPDATE: Actualizar empresa propia
...
-- ===========================================
-- 9. POLÍTICAS RLS PARA company_documents
-- ===========================================
...
-- Trigger para company_documents
...
-- ===========================================
-- 11. FUNCIÓN PARA CALCULAR word_count
-- ===========================================
